...
export function TRPricingContactCtaBlock() {
    ...
    const submitLabel = resolveCtaLabel(finalCta.primaryCta);
    const whatsappLabel = resolveCtaLabel(finalCta.secondaryCta);
                    ...
                    <div className="grid gap-16 lg:grid-cols-[1fr_1.2fr] lg:items-start max-w-6xl mx-auto">
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="pt-8 border-t border-neutral-100">
                                ...
                                <a href={whatsappHref} target="_blank" rel="noopener noreferrer" className="inline-block">
                        ...
                        <form
                            ...
                            className="space-y-6 rounded-3xl border border-neutral-200 bg-neutral-50/10 p-6 shadow-sm sm:p-10 transition-all duration-300 hover:shadow-xl hover:shadow-neutral-100"
                        >
                            ...
                            <FormField 
                                label="Sürecinizi kısaca anlatın"
