        ...
        <SectionWrapper className={className}>
            <ContentContainer className="pt-24 pb-16 md:pt-32 md:pb-24">
                <div className="max-w-4xl">
                    ...
                    <SectionTitle size="lg" className="mb-8 tracking-tight leading-[1.1] max-w-3xl">{title}</SectionTitle>
        ...
        <SectionWrapper className={className}>
            <ContentContainer className="py-20 md:py-32">
                ...
                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                    {items.map((item: any, idx: number) => (
                        <div key={idx} className="flex flex-col p-8 rounded-[2.5rem] border border-neutral-100 bg-white shadow-sm hover:shadow-md transition-shadow">
                            <div className="mb-8">
...
export function GlobalServicesPagePrimaryFocusBlock({ content, className }: { content: any, className?: string }) {
    ...
    return (
        <SectionWrapper className={className}>
            <ContentContainer className="py-20 md:py-32 bg-neutral-900 rounded-[3rem] overflow-hidden relative">
                ...
                <div className="max-w-4xl mx-auto text-center relative z-10 px-8">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-neutral-400 text-[10px] font-black uppercase tracking-widest mb-8">
                    ...
                    <p className="text-neutral-400 text-lg md:text-xl font-medium mb-10 max-w-2xl mx-auto italic leading-relaxed">
                        "{highlight}"
                    </p>
                    <SectionDescription className="text-neutral-500 text-sm md:text-base mb-12 max-w-2xl mx-auto">
                        {description}
                    </SectionDescription>
        ...
        <SectionWrapper className={`bg-neutral-50/50 ${className}`}>
            <ContentContainer className="py-24 md:py-32">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 px-4 md:px-0">
                    {items.map((item: any, idx: number) => (
                        <CardBase key={idx} className="p-8 bg-white border-neutral-100 rounded-2xl flex flex-col items-center text-center shadow-sm">
...
export function GlobalServicesPageUseCaseBridgeBlock({ content, className }: { content: any, className?: string }) {
    ...
    return (
        <SectionWrapper className={className}>
            <ContentContainer className="py-24 md:py-32 border-b border-neutral-100">
                ...
                <div className="grid gap-6 md:grid-cols-3">
                    {items.map((item: any, idx: number) => (
                        <div key={idx} className="p-8 rounded-[2rem] bg-neutral-50/30 border border-neutral-100/50 hover:bg-neutral-100 transition-colors cursor-pointer group">
                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <div className="grid gap-6 md:grid-cols-3 mb-16">
                        {logicBlocks.map((block: any, idx: number) => (
                            <div key={idx} className="p-8 rounded-2xl bg-white border border-neutral-100 shadow-sm text-left">
        ...
        <SectionWrapper className={`bg-neutral-50/50 ${className}`}>
            <ContentContainer className="py-24 md:py-32">
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    {/* Good Fit */}
                    <CardBase className="p-10 bg-white border-neutral-100 shadow-sm rounded-[2rem]">
...
export function GlobalServicesPageFinalCtaBlock({ content, className }: { content: any, className?: string }) {
    ...
    return (
        <SectionWrapper className={className}>
            <ContentContainer className="py-20 md:py-32">
                <CardBase className="p-12 md:p-24 bg-neutral-900 rounded-[3.5rem] text-center max-w-5xl mx-auto border-none shadow-2xl overflow-hidden relative">
                    ...
                    <div className="relative z-10">
                        <SectionTitle size="md" className="text-white mb-6 tracking-tight max-w-2xl mx-auto">{title}</SectionTitle>
                        <SectionDescription className="text-neutral-500 mb-12 max-w-xl mx-auto leading-relaxed font-medium">
                            {description}
                        </SectionDescription>
                        ...
                        <div className="flex flex-col items-center gap-12">
                            ...
                            <div className="flex flex-wrap items-center justify-center gap-x-12 gap-y-6 pt-12 border-t border-neutral-800/60 w-full max-w-2xl mx-auto">
