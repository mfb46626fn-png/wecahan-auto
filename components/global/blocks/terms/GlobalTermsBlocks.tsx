...
export function GlobalTermsHeroBlock({ content, lastUpdated, className }: GlobalTermsHeroBlockProps) {
    ...
    return (
        <div className={`border-b border-neutral-100 bg-neutral-50/50 ${className}`}>
            <div className="mx-auto max-w-4xl px-6 py-12 md:px-10 md:py-24 lg:py-32">
                <span className="text-[10px] font-black uppercase tracking-[0.3em] text-neutral-400">
                    {eyebrow}
                </span>
                <h1 className="mt-4 md:mt-6 text-4xl font-bold tracking-tight text-neutral-900 md:text-5xl">
                    {title}
                </h1>
                <p className="mt-6 md:mt-8 max-w-2xl text-lg leading-relaxed text-neutral-500 font-medium">
                    {description}
                </p>
...
export function GlobalTermsContentBlock({ summary, sections, className, children }: GlobalTermsContentBlockProps) {
    return (
        <div className={`mx-auto max-w-4xl px-6 py-12 md:px-10 md:py-24 lg:py-32 ${className}`}>
            <div className="max-w-2xl">
                {summary && (
                    <p className="text-xl font-bold leading-relaxed tracking-tight text-neutral-900 mb-12 md:mb-16 lg:mb-20">
                        {summary}
                    </p>
                )}
...
export function GlobalTermsContactNoteBlock({ contactNote, className }: GlobalTermsContactNoteBlockProps) {
    return (
        <div className={`mt-16 pt-10 md:mt-24 md:pt-16 lg:mt-32 border-t border-neutral-100 ${className}`}>
            <div className="rounded-3xl bg-neutral-50 p-6 md:p-8 lg:p-10">
